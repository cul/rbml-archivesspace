...
def main():
    ...
    the_report_sheet=dataSheet('1wNO0t2j5G9U0hUmb7E-jLd4T5skTs1aRxN7HrlyZwEI','daos-prod!A:Z')
    ...
    for an_obj in the_ids:
        ...
        try:
            ...
            y['file_versions'][0]['file_uri'] = re.sub(r"^(.*)-staging(.*)'$", r'\1\2', x['file_versions'][0]['file_uri'])
